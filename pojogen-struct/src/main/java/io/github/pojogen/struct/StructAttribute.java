...
public class StructAttribute {
   ...
   */
  private StructAttribute(final String name, final String typeName, final boolean constant) {
    this.name = name;
  ...
  public static StructAttribute create(final String name) {
    ...
    return new StructAttribute(name, Object.class.getSimpleName(), false);
  }
  ...
  public static StructAttribute create(final String name, final String typeName) {
    ...
    return new StructAttribute(name, typeName, false);
  }
  ...
  public static StructAttribute copyOf(final StructAttribute struct) {
    ...
    return new StructAttribute(struct.getName(), struct.getTypeName(), struct.isConstant());
  }
}
